    ...
    return (
        <header className="topbar">
            <div className="topbar-logo">
                <img id="topbar-logo" src={bevspotLogo} alt="BevSpot" />
            </div>
            <div className="topbar-actions">
                <button id="save-proposal" className="action-btn secondary">
                ...
                <button id="sync-form" className="action-btn secondary">
                ...
                <button id="send-signing" className="action-btn primary">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M16 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2"/><circle cx="8.5" cy="7" r="4"/><polyline points="17 11 19 13 23 9"/></svg>
                    Send to Sign
                </button>
            </div>
        </header>
